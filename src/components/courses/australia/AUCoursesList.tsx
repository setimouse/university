...
import { auCourseCategories } from "@/config/au-courses";
...
export default function AUCoursesList() {
  ...
  const currentCategory = auCourseCategories.find(
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex rounded-lg border border-gray-200 bg-white p-1">
            {auCourseCategories.map((category) => (
              <button
                key={category.id}
                ...
                <div className="space-y-4 mt-6">
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className="font-medium">A${course.tuition}</div>
                    </div>
                  </div>
                  <a
                    href={course.link}
